-- ============================================================
-- Admin Panel — Migration: tabla sources + editorial_pick
-- ============================================================

-- Drop si existe con schema viejo
...
create policy "Admin full access to sources"
  on public.sources for all using (true) with check (true);

-- Seed: fuentes conocidas
